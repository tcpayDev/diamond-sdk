...
public class HttpUtil {
    ...
    private static final Response post(String url, String data) throws IOException {
        ...
        String responseString = httpClient.newCall(new okhttp3.Request.Builder().post(RequestBody.create(MediaType.parse("application/json"), data)).url(url).build()).execute().body().string();
